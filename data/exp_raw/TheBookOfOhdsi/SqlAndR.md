...
```
## [1] "SELECT * FROM temp_schema.fchjosk9children ;"
## attr(,"sqlDialect")
## [1] "oracle"
```
...
Using SQL and R, compute how many people have at least one prescription of celecoxib.

:::
::: {.exercise #exerciseGiBleedsDuringCelecoxib}
Using SQL and R, compute how many diagnoses of gastrointestinal hemorrhage  occur during exposure to celecoxib. (Hint: the concept ID for gastrointestinal hemorrhage is [192671](http://athena.ohdsi.org/search-terms/terms/192671).)
